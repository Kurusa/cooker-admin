    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_step_header">
                <h2 class="fw-bold">{{ $edit_mode ? 'Edit Step' : 'Add Step' }}</h2>
            ...
            <div class="modal-body px-5 my-7">
                <form id="kt_modal_add_step_form" class="form" wire:submit.prevent="submit">
                    <input type="hidden" wire:model.defer="step_id" name="step_id" value="{{$step_id}}"/>
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_step_scroll">
                        <div class="fv-row mb-7">
                            <label class="required fw-semibold fs-6 mb-2">Recipe</label>
                            <select wire:model.defer="recipe_id" name="recipe_id" class="form-select form-control-solid">
