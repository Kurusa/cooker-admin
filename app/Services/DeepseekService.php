            ...
            $response = $this->client->post('/chat/completions', [
                'json' => [
                    ...
                    'messages' => [
                        ...
                        [
                            'role' => 'user',
                            'content' => "Розпарси інгредієнти у форматі JSON-масиву з об'єктами, де кожен об'єкт має ключі: title, unit, quantity. Поверни лише цей масив без пояснень, без додаткового тексту і описів.
                            ...
                            Замінюй нетипові лапки на стандартні. Інгредієнти:" . implode(',', $ingredients)],
                    ],
                    'stream' => false,
                ],
            ]);
